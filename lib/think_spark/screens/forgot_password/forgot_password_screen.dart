...
import 'package:think_spark/think_spark/screens/forgot_password/forgot_password_bloc_listener.dart';
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: DefaultTabController(
            length: 2,
            child: Form(
              key: forgotPasswordCubit.forgotFormKey,
              child: Column(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              IntlPhoneField(
                                ...
                                onChanged: (phone) {
                                  forgotPasswordCubit.countryCode =
                                      phone.countryCode;
                                  forgotPasswordCubit.phoneController.text =
                                      phone.number;
                                },
                  ...
                  SizedBox(
                    ...
                    child: Builder(builder: (tabContext) {
                      return ElevatedButton(
                          onPressed: () {
                            if (forgotPasswordCubit.forgotFormKey.currentState!
                                .validate()) {
                              final tabIndex =
                                  DefaultTabController.of(tabContext).index;
                              forgotPasswordCubit
                                  .addForgotPasswordIdentifier(tabIndex);
                            }
                          },
