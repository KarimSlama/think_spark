...
class _IdeaService implements IdeaService {
  ...
  Future<IdeaResponse> updateIdea(
    int ideaId,
    IdeaRequestBody ideaRequest,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(ideaRequest.toJson());
    final _options = _setStreamType<IdeaResponse>(Options(
      method: 'PATCH',
      headers: _headers,
      extra: _extra,
    )
    ...
    late IdeaResponse _value;
    try {
      _value = IdeaResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
