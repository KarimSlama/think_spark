...
abstract class Success implements ProfileState {
  const factory Success(final ProfileResponse profile) = _$SuccessImpl;
...
class __$$StepChangedImplCopyWithImpl<$Res>
    extends _$ProfileStateCopyWithImpl<$Res, _$StepChangedImpl>
...
class _$StepChangedImpl implements StepChanged {
  const _$StepChangedImpl({required this.stepIndex});
  ...
  @override
  String toString() {
    return 'ProfileState.stepChanged(stepIndex: $stepIndex)';
  }
...
abstract class StepChanged implements ProfileState {
  const factory StepChanged({required final int stepIndex}) = _$StepChangedImpl;
