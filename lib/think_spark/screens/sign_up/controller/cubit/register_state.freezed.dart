...
class _$ErrorImpl<T> implements Error<T> {
  const _$ErrorImpl({required final Map<String, List<String>?>? errors})
      : _errors = errors;
  ...
  @override
  String toString() {
    return 'RegisterState<$T>.error(errors: $errors)';
  }
...
abstract class Error<T> implements RegisterState<T> {
  const factory Error({required final Map<String, List<String>?>? errors}) =
      _$ErrorImpl<T>;
...
class __$$ChangedImplCopyWithImpl<T, $Res>
    extends _$RegisterStateCopyWithImpl<T, $Res, _$ChangedImpl<T>>
...
class _$ChangedImpl<T> implements Changed<T> {
  ...
  @override
  String toString() {
    return 'RegisterState<$T>.passwordChanged(isPassword: $isPassword)';
  }
...
abstract class Changed<T> implements RegisterState<T> {
